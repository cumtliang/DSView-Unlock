...
namespace dsv
{
    namespace toolbars
    {
            ...
            _mode_button(this)
        {
            ...
            QStringList displayValues = { "20K","40K","80K","100K","200K","400K","800K","1M","2M", "4M", "6M", "8M", "10M", "12M", "14M", "16M", "18M", "20M", "22M", "24M", "26M", "28M", "30M", "32M","34M","36M","38M","40M","42M","44M","46M","48M","50M","52M","54M","56M","58M","60M","62M","64M" };
            QList<int> actualValues = { 20000,40000,80000,100000,200000,400000,800000,1000000,2000000, 4000000, 6000000, 8000000, 10000000, 12000000, 14000000, 16000000, 18000000, 20000000, 22000000, 24000000, 26000000, 28000000, 30000000, 32000000,34000000,36000000,38000000,40000000,42000000,44000000,46000000,48000000,50000000,52000000,54000000,56000000,58000000,60000000,62000000,64000000 };

            for (int i = 0; i < displayValues.size(); i++) {
                _sample_limit_combobox.addItem(displayValues[i], actualValues[i]);
            }
            int index = _sample_limit_combobox.findText("12M");
            if (index != -1) {
                _sample_limit_combobox.setCurrentIndex(index);
            }
