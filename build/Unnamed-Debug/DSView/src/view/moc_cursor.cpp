...
struct qt_meta_stringdata_dsv__view__Cursor_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_dsv__view__Cursor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dsv__view__Cursor_t qt_meta_stringdata_dsv__view__Cursor = {
    {
QT_MOC_LITERAL(0, 0, 17) // "dsv::view::Cursor"
...
static const uint qt_meta_data_dsv__view__Cursor[] = {
...
QT_INIT_METAOBJECT const QMetaObject dsv::view::Cursor::staticMetaObject = { {
    QMetaObject::SuperData::link<TimeMarker::staticMetaObject>(),
    qt_meta_stringdata_dsv__view__Cursor.data,
    qt_meta_data_dsv__view__Cursor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *dsv::view::Cursor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dsv__view__Cursor.stringdata0))
