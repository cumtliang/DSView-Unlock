...
struct qt_meta_stringdata_dsv__view__LogicSignal_t {
    QByteArrayData data[1];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_dsv__view__LogicSignal_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dsv__view__LogicSignal_t qt_meta_stringdata_dsv__view__LogicSignal = {
    {
QT_MOC_LITERAL(0, 0, 22) // "dsv::view::LogicSignal"
...
static const uint qt_meta_data_dsv__view__LogicSignal[] = {
...
QT_INIT_METAOBJECT const QMetaObject dsv::view::LogicSignal::staticMetaObject = { {
    QMetaObject::SuperData::link<Signal::staticMetaObject>(),
    qt_meta_stringdata_dsv__view__LogicSignal.data,
    qt_meta_data_dsv__view__LogicSignal,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *dsv::view::LogicSignal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dsv__view__LogicSignal.stringdata0))
