...
struct qt_meta_stringdata_dsv__prop__Int_t {
    QByteArrayData data[3];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_dsv__prop__Int_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_dsv__prop__Int_t qt_meta_stringdata_dsv__prop__Int = {
    {
QT_MOC_LITERAL(0, 0, 14), // "dsv::prop::Int"
QT_MOC_LITERAL(1, 15, 16), // "on_value_changed"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "dsv::prop::Int\0on_value_changed\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_dsv__prop__Int[] = {
...
QT_INIT_METAOBJECT const QMetaObject dsv::prop::Int::staticMetaObject = { {
    QMetaObject::SuperData::link<Property::staticMetaObject>(),
    qt_meta_stringdata_dsv__prop__Int.data,
    qt_meta_data_dsv__prop__Int,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *dsv::prop::Int::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_dsv__prop__Int.stringdata0))
